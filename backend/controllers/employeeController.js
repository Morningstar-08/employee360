...
exports.predictAttrition = async (req, res) => {
    try {
      ...
      const response = await axios.post("http://localhost:5000/predict", employee);
      ...
      employee.attritionClassification = attrition_class;
      ...
      res.status(500).json({ error: "Prediction failed or Flask API unreachable." });
    }
  };